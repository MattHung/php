/**
 * Created by matt_hung on 2015/9/10.
 */
...
var dymaicmodule = angular.module('dymaicmodule', []);
...
(function () {
    ...
    function DynamicDirectiveManager($compileProvider, dynamicDirectiveSuffixGenerator) {
        ...
        this.registerDirective = function (normalizedName, constructor, suffix) {
            ...
            if (!$compileProvider) {
                app.module.directive(nameWithSuffix, constructor);
            } else {
    ...
    dymaicmodule.provider('dynamicDirectiveManager', DynamicDirectiveManagerProvider);
    dymaicmodule.service('dynamicDirectiveSuffixGenerator', DynamicDirectiveSuffixGenerator);
    dymaicmodule.directive('dynamicDirective', Directive);
})();
